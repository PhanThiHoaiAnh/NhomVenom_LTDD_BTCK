package com.example.quanlythuvien.sach;
...
public class SachGiaoDucAdapter extends FirebaseRecyclerAdapter<Sach,SachGiaoDucAdapter.myViewHolder> {
    /**
     ...
     * @param options
     */
    public SachGiaoDucAdapter(@NonNull FirebaseRecyclerOptions<Sach> options) {
        super(options);
    }
